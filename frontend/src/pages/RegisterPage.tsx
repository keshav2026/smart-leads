...
const RegisterPage = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<RegisterForm>({ defaultValues: { role: 'sales' } });
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-white/70 mt-4 text-lg">
              Join your team on Smart Leads and start converting more prospects today.
            </p>
          </div>
          <div className="space-y-4">
            {[
              ...
              { icon: TrendingUp, text: 'Full lead lifecycle management' },
            ].map(({ icon: Icon, text }) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">Join Smart Leads and start managing your pipeline.</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full gradient-blue text-white py-3 rounded-xl font-semibold text-sm hover:opacity-90 transition-opacity disabled:opacity-60 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25 mt-2"
              >
                {isLoading ? (
